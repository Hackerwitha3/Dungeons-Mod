...
public class EvocationRobeChestplate extends ArmorItem {
    public EvocationRobeChestplate(IArmorMaterial materialIn, EquipmentSlotType slot, Properties p_i48534_3_) {
